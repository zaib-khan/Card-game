...
public class GameSwing implements GameViewable {
    ...
    public void createAndShowGUI() {
        ...
        // all the controls will appear vertically
    ...
    @Override
    public void showCardForPlayer(int num, String playerName, String cardRank, String cardSuit) {
        appendText("[" + num + "][" + playerName + "][" + cardRank + ":" + cardSuit + "]");
    }
